          ...
          $stateProvider
              ...
              // projects
                  ...
                  resolve: {
                      deps: ['uiLoad',
                          function( uiLoad ){
                              return uiLoad.load( ['js/app/projects/projects.js',
                                  'js/app/projects/projects-service.js',
                                  JQ_CONFIG.moment] );
                          }]
                  }
              })
              ...
              .state('app.projects.detail', {
                  url: '/{projectsId:[0-9]{1,4}}',
                  templateUrl: 'tpl/projects.detail.html'
              })
              .state('app.projects.compose', {
                  url: '/compose',
                  templateUrl: 'tpl/projects.new.html'
              })
              ...
              .state('app.clients', {
                  ...
                  resolve: {
                      deps: ['uiLoad',
                          function( uiLoad ){
                              return uiLoad.load( ['js/app/clients/clients.js',
                                  'js/app/clients/clients-service.js',
                                  JQ_CONFIG.moment] );
                          }]
                  }
              })
              .state('app.clients.list', {
                  url: '/inbox/{fold}',
                  templateUrl: 'tpl/clients.list.html'
              })
              .state('app.clients.detail', {
                  url: '/{clientsId:[0-9]{1,4}}',
                  templateUrl: 'tpl/clients.detail.html'
              })
              .state('app.clients.compose', {
                  url: '/compose',
                  templateUrl: 'tpl/clients.new.html'
              })
              ...
              .state('app.sms', {
                  ...
                  resolve: {
                      deps: ['uiLoad',
                          function( uiLoad ){
                              return uiLoad.load( ['js/app/sms/sms.js',
                                  'js/app/sms/sms-service.js',
                                  JQ_CONFIG.moment] );
                          }]
                  }
              })
              .state('app.sms.list', {
                  url: '/inbox/{fold}',
                  templateUrl: 'tpl/sms.list.html'
              })
              .state('app.sms.detail', {
                  url: '/{smsId:[0-9]{1,4}}',
                  templateUrl: 'tpl/sms.detail.html'
              })
              .state('app.sms.compose', {
                  url: '/compose',
                  templateUrl: 'tpl/sms.new.html'
              })
