app.controller('MailCtrl', ['$scope', function($scope) {
  $scope.folds = [
    {name: 'Вхідні', filter:''},
    {name: 'Відправленні', filter:'sent'},
    {name: 'Чернетки', filter:'important'},
    {name: 'Видаленні', filter:'trash'}
  ];

  $scope.labels = [

    {name: 'Замовники', filter:'client', color:'#fad733'},
    {name: 'Команда', filter:'work', color:'#27c24c'}
  ];
...
app.controller('MailNewCtrl', ['$scope', function($scope) {
  ...
  $scope.tolist = [
    ...
    {name: 'Lucssssy Yokes', email:'lucy.yoksdfes@gmail.com'},
    {name: 'Lucsssdfdsfy Yokes', email:'lucy.yosdfkes@gmsdfail.com'},
    {name: 'Lucsdfsdfy Yokes', email:'lucy.yokes@gmsdfail.com'},
  ];
}]);
